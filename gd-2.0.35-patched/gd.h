...
BGD_DECLARE(void) gdImageColorMatch(gdImagePtr im1, gdImagePtr im2);
...
BGD_DECLARE(void) gdImagePngEx (gdImagePtr im, FILE * out, int level, int basefilter);
BGD_DECLARE(void) gdImagePngCtxEx (gdImagePtr im, gdIOCtx * out, int level, int basefilter);
